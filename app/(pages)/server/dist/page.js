        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, (react_1["default"].createElement("main", { className: "flex h-full items-center justify-center flex-col gap-2" },
                        react_1["default"].createElement("h1", { className: "text-3xl" }, "Server page"),
                        react_1["default"].createElement("p", { className: "text-lg" }, (_a = session === null || session === void 0 ? void 0 : session.user) === null || _a === void 0 ? void 0 : _a.email)))];
        }
    });
}); };
