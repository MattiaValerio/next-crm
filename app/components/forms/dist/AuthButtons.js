...
exports.ProfileButton = exports.LogoutButton = exports.LoginButton = void 0;
...
exports.ProfileButton = function () {
    return React.createElement(link_1["default"], { className: "border text-center px-2", href: "/server" }, "Profile");
};
